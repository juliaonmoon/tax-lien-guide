...
def main():
    ...
    if "Alabama — state-held inventory" in html and "Nebraska — county tax sales" in html:
        print("Alabama and Nebraska already present")
        return
    ...
    print("Added Alabama and Nebraska tax-lien market rows")
