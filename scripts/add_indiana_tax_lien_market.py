...
ROWS = {
    ...
    "Indiana — Floyd County 2026": r'''{state:'Indiana — Floyd County 2026',product:'Tax sale certificate / property-tax lien',schedule:'Floyd County\'s official 2026 Tax Sale is <span class="schedule-date">October 15, 2026</span>. The county states the sale will be completely online.',availability:'Upcoming — official 2026 sale date and online format published',interest:'Indiana tax-sale purchaser returns are governed by the statutory redemption framework rather than a simple APR. Verify the current Floyd County/SRI sale packet and Indiana Code 6-1.1-24 and 6-1.1-25 for the exact redemption amount, notice obligations, and parcel-specific sale path.',bid:'https://www.in.gov/counties/floyd/department/treasurer/',canadian:'Not confirmed — verify current Floyd County/SRI bidder-registration and taxpayer-document requirements directly before participating.',itin:'Do not assume an ITIN or W-8 alone is accepted; verify Floyd County/SRI\'s current registration requirements.',online:'YES — Floyd County states the 2026 tax sale will be completely online and directs bidders to SRI for registration and sale information.',otc:'Annual tax sale only in this market summary. Floyd County separately adopted a 2026 Commissioners Tax Certificate Sale resolution; do not treat that separate certificate-sale path as identical to the October annual tax sale.',deed:'Purchaser receives a tax-sale certificate/lien first. A tax deed is not immediate; statutory redemption, notice, and deed procedures apply separately under Indiana law.',special:'MARKET-LEVEL SUMMARY ONLY. The official Treasurer page confirms the 2026 date and online format but does not provide a verified unrestricted machine-readable current parcel inventory here. Do not bulk republish owner names, infer current inventory or opening/minimum bids, bypass SRI registration controls, or confuse Sheriff/judicial foreclosure sales with the Treasurer tax sale.',source:'https://www.in.gov/counties/floyd/department/treasurer/'}''',
}
